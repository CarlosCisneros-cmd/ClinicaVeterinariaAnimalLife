...
public class PacienteController {
	...
	@GetMapping("buscarid/{idPaciente}")
	public PacienteResponseDTO buscarPorId(@PathVariable int idPaciente) {
		return mapper.toResponseDto(pacienteUseCase.obtenerPoriD(idPaciente));
